...
// https://bitbucket.org/dok/fifteenpuzzle/src/default/src/main/java/ru/dokwork/fifteen/FifteenRules.java
...
/**
 * Определяет специфичные для задачи правила ее решения. В данной реализации эвристика вычисляется
 * как количество клеток, находящихся не на своих местах.
 */
public class FifteenRules implements Rules<FifteenState> {

  public List<FifteenState> getNeighbors(FifteenState currentState) {
    ArrayList<FifteenState> res = new ArrayList<>();
  ...
  public int getQuality(FifteenState state) {
    int res = 0;
   ...
   * @return новое состояние, полученное в результате применения правила. null если состояние
   *     недопустимо.
   */
